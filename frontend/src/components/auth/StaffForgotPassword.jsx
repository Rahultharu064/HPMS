...
const StaffForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await authService.forgotStaffPassword(email);
      setSuccess(true);
    } catch (err) {
        ...
        <div className="relative w-full max-w-md mx-auto">
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
            ...
            <div className="bg-blue-500/20 border border-blue-500/50 text-blue-200 px-4 py-3 rounded-xl text-sm mb-6">
              <p>Please check your email and click on the reset link to create a new password.</p>
            </div>

            {/* Back to Login */}
            <Link
              to="/staff/login"
              className="w-full flex justify-center items-center gap-2 py-4 px-6 border border-white/20 rounded-xl text-sm font-semibold text-white hover:bg-white/10 transition-all duration-200"
            >
      ...
      <div className="relative w-full max-w-md mx-auto">
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
          ...
          <div className="text-center mt-6">
            <Link to="/staff/login" className="inline-flex items-center gap-2 text-gray-300 hover:text-white transition-colors">
              <ArrowLeft className="w-4 h-4" />
              Back to Login
            </Link>
          </div>
